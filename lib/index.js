...
var Hexagon = /** @class */ (function (_super) {
    ...
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 1.5 })
    ], Hexagon.prototype, "borderSize", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: "#000" })
    ], Hexagon.prototype, "borderColor", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: 100 })
    ], Hexagon.prototype, "size", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: "#fff" })
    ], Hexagon.prototype, "backgroundColor", void 0);
    __decorate([
        vuePropertyDecorator.Prop({ required: false, default: undefined })
